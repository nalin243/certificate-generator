...
<head>
    <?php
        ...
        require $rootdir.$path. 'config/env_config.php';
        require $rootdir.$path. 'config/db_config.php';
        require $rootdir.$path. 'config/mail_config.php';
        ...
        require $rootdir. "/certificate-generator/modules/Student_Page/" . 'get_participants.php';
...
<body OnLoad="document.phone.first.focus();">
    <div class="flex flex-col page h-screen min-w-screen overflow-auto">
        <div id="main-container" class="flex flex-col">
            ...
            <div id="inputs" class="inputs flex h-1/6  w-full justify-center">
                <form id="phone" name="phone" method="POST" action="student_page.php">
    ...
    <script>
                ...
                if(number.length==10){
                    ...
                    httpRequest.open("GET",`../modules/Student_Page/verify_number.php?number=${number}`,true)
                    httpRequest.send()
                } else {
                    if(!document.querySelector(".otp-btn").classList.contains("hidden"))
                        document.querySelector(".otp-btn").classList.add("hidden")
