...
<body>
                    ...
                    <div class="px-3 flex m-auto">
                        <form method="POST" action="../modules/Auth/logout.php" class="m-auto">
                            ...
                            <button type="submit" name="submit" value="submit" class="text-center font-bold text-lg ">
                                <img class="h-5/6 w-3/12 m-auto" src="../public/assets/logout.png" />
                                Logout
                            </button>
                        </form>
                    </div>     
                    ...
                    <div class="flex flex-col h-full w-full m-auto">
                        ...
                        <div class="flex h-2/6 w-full justify-start mt-10 border-2 border-black rounded-md">
                            <div class="flex h-full w-1/6">
                                <img class="h-4/6 w-4/6 m-auto cursor-pointer" src="../public/assets/ename.png" />
                            </div>
                        ...
                        <div class="flex h-2/6 w-full mt-5 border-2 border-black rounded-md">
                            <div class="flex h-full w-1/6">
                                <img class="h-4/6 w-4/6 m-auto cursor-pointer" src="../public/assets/edate.png" />
                            </div>
    ...
    <script>
        ...
        let eventDetailCallback = function(){
            ...
            httpRequest.open("GET",`../modules/Dean_Page/get_event_details.php?deptname=${dept}`,true)
            httpRequest.send()
        }
        ...
        document.querySelector(".grant-btn").addEventListener("click",(event)=>{
            ...
            if(permission)
                httpRequest.open("GET",`../modules/Dean_Page/grant_permission.php?permission=${0}&eventname=${eventname}`,true)
            else
                httpRequest.open("GET",`../modules/Dean_Page/grant_permission.php?permission=${1}&eventname=${eventname}`,true)
